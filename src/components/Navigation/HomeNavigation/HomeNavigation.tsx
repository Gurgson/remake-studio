...
const HomeNavigation : FC = async () => {
  ...
  return (
    <nav className=' drop-shadow-sm text-primary-black sticky w-full py-4 z-40 flex justify-between items-center border-b-2 border-b-secondary-grey  bg-primary-white'>
        <Logo/>
